...
exports.signup = (async (req, res) => {
    ...
    //         service: 'gmail',
    //         auth: {
    //             user: 'kouzintyapp@gmail.com',
    //             pass: 'kouzintyapp2021',

    //         }
    //     });


    //     var mailOptions = { from: 'kouzintyapp@gmail.com', to: user.email, subject: 'Account Verification Link', text: 'Hello ' + user.firstName + ',\n\n' + 'Please verify your account by clicking the link: \nhttp:\/\/' + req.headers.host + '\/users\/confirmation\/' + user.email + '\/' + token.token + '\n\nThank You!\n' };
