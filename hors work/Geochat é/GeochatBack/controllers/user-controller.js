...
exports.signup = async (req, res) => {
    const { email, password, firstname, lastname, age, sexe, location } = req.body;
...
exports.editProfile = async (req, res) => {
    const { email, firstname, lastname, age, sexe, location, isVerified } = req.body;
